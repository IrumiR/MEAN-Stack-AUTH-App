...
export const sendEmail = async (req, res, next)=>{
    ...
    const mailTransporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: "irumidisara@gmail.com",
            pass: "ukto hbjh tzqo aiqv"
        },
        // As this is only used in development stage, keep this. But in production stage remove this.
        // 2023/12/05
        tls: {
    ...
    let mailDetails = {
        ...
        <p>We have received a request to reset your password for your account with BookMyRead. To complete the password reset process, please click on the button below:</p>
    ...
    jwt.verify(token, process.env.JWT_SECRET, async(err, data)=>{
        if(err){
            ...
            try {
                ...
                return next(CreateSuccess(200, "Password Reset Sucess!"));
            } catch (error) {
